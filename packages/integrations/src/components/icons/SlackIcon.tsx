...
const SlackIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox='0 0 48 48' {...props}>
    ...
    <path
      fill='#ffc107'
      d='M39,32.006c2.209,0,4-1.788,4-3.994s-1.791-3.994-4-3.994c-1.254,0-9.741,0-11,0c-2.209,0-4,1.788-4,3.994	s1.791,3.994,4,3.994C29.258,32.006,37.746,32.006,39,32.006z'
    ></path>
    <path
      fill='#ffc107'
